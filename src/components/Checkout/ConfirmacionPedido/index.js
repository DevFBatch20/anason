            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-6 col-sm-push-6">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        Revisar Orden <div class="pull-right"><small><a class="afix-1" href="#">Edit Cart</a></small></div>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="col-xs-12">Proteína</div>
                                <div class="col-xs-12"><small>Cantidad:<span>2</span></small></div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="col-xs-12">Toallitas Femeninas</div>
                                <div class="col-xs-12"><small>Quantity:<span>3</span></small></div>
                            </div>
                            <div class="col-sm-3 col-xs-3 text-right">
                                <h6><span>$</span>25.00</h6>
                            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-12"><strong>Número de Celular:</strong></div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <a href='/Recibo' type="submit" class="btn btn-primary btn-submit-fix">Realizar Orden</a>
                            </div>
                        </div>
                    </div>
                </div>
